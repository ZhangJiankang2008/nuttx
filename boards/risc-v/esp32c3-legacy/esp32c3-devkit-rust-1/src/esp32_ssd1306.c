/****************************************************************************
 * boards/risc-v/esp32c3-legacy/esp32c3-devkit-rust-1/src/esp32c3_ssd1306.c
 *
...
#if !defined(CONFIG_ESP32C3_I2C) || !defined(CONFIG_ESP32C3_I2C0) || \
    !defined(CONFIG_LCD_SSD1306_I2C)
#  undef HAVE_SSD1306
#endif

#define GPIO_SSD1306_RST 7
...
int board_lcd_initialize(void)
{
  ...
  esp32c3_gpio_matrix_out(GPIO_SSD1306_RST, SIG_GPIO_OUT_IDX, 0, 0);
  esp32c3_configgpio(GPIO_SSD1306_RST, OUTPUT_FUNCTION_3 | INPUT_FUNCTION_3);
  esp32c3_gpiowrite(GPIO_SSD1306_RST, 0);

  /* Wait a bit then release the OLED from the reset state */

  up_mdelay(20);
  esp32c3_gpiowrite(GPIO_SSD1306_RST, 1);
